...
import OnboardingReact from './OnboardingReact';
 ...
 *
 */
const Onboarding = ({ children, steps, shadowRgb = '0, 0, 0', shadowOpacity = '0.2', cardTransition = { ease: 'anticipate', duration: 0.6 }, cardComponent: CardComponent, onStart = () => { }, onStepChange = () => { }, onComplete = () => { }, onSkip = () => { }, displayArrow = true, clickThroughOverlay = false, navigationAdapter = useNextAdapter, disableConsoleLogs = false, scrollToTop = true, noInViewScroll = false, labels, i18n, }) => {
    return (_jsx(OnboardingReact, { children: children, steps: steps, shadowRgb: shadowRgb, shadowOpacity: shadowOpacity, cardTransition: cardTransition, cardComponent: CardComponent, onStart: onStart, onStepChange: onStepChange, onComplete: onComplete, onSkip: onSkip, displayArrow: displayArrow, clickThroughOverlay: clickThroughOverlay, navigationAdapter: navigationAdapter, disableConsoleLogs: disableConsoleLogs, scrollToTop: scrollToTop, noInViewScroll: noInViewScroll, labels: labels, i18n: i18n }));
};
